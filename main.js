...
console.log('%c Website created with passion 🎸🔥 ', 'color: #888888; font-size: 12px;');
...
function activateEasterEgg() {
    ...
    console.log('%c 🎸 METAL MODE ACTIVATED! 🔥 ', 'background: #ff0040; color: #ffffff; font-size: 24px; font-weight: bold; padding: 20px;');
}
